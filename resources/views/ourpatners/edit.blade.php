...
<div class="app-main__inner">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
        <form action="{{ route('our-partners.update',$ourpartners->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PATCH') }}
            <div class="row">
                <div class="form-group col-lg-12">
                    <label for="">Partners</label>
                    <input id="email" type="text" class="form-control"  name="partner_name"  value="{{ $ourpartners->partner_name }}" placeholder="Name" required  autofocus>
                </div>

                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="">Profile</label>
                        <textarea  class="form-control" name="description" id="">{{ $ourpartners->description }}</textarea>
                    </div>
                 </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea   class="form-control" name="specialization_area" id="">{{ $ourpartners->specialization_area }}</textarea>
                    </div>
                </div>
