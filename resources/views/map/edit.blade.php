        ...
        <div class="row">
            <div class="col-8">
                <div class="page-title-box py-2">
                    <h4 class="mb-0 pb-0">Edit {{$data->country}} Matrices Status </h4>
                </div>
            </div>
            <div class="col-4 text-right text-white d-flex align-items-center justify-content-end">
                <a class="text-info btn btn-outline-info" href="{{route('map-data.index')}}">View Map</a>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        ...
        <form action="{{ route('map-data.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-lg-12">
                ...
                <textarea id="editor" class="form-control" name="status" id="" cols="30" rows="5"> {{$data->status}} </textarea>
            </div>
            <div class="form-group col-lg-12">
