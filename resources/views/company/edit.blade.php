...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('company.update', $branch->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}

                        <div class="form-group">
                            <label for="">Branch Name</label>
                            <input type="text" name="companyName" value="{{ $branch->companyName }}" class="form-control" required>
                            @error('companyName')
